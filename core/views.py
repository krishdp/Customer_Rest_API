...
from .serializers import (CustomerSerializer, ProfessionSerializer, DataSheetSerializer, DocumentsSerializer)
...
class CustomerViewSet(viewsets.ModelViewSet):
    ...
    #         data_sheet_id=data['data_sheet_id']
    #     )
    ...
    def update(self, request, *args, **kwargs):
        ...
        customer.data_sheet_id = data['data_sheet_id']
    ...
    def destroy(self, request, *args, **kwargs):
        ...
        return Response('Object Successfully Destroyed')
